...
def bids_validate(
    dir_: DirectoryPath, ignore_nifti_headers: bool = False, recursive: bool = False
    ...
    try:
        bv_result = _bids_validate(dir_, ignore_nifti_headers, recursive)
...
def _bids_validate(
    ...
    pydantic.ValidationError
        If `dir_` is not pointing to a valid directory or not provided at all
    """
    ...
    with TemporaryDirectory() as tmp_dir:
        outfile_path = Path(tmp_dir) / outfile_name
